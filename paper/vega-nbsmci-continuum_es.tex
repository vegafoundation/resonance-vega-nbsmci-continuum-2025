...
\title{VEGA NBSMCI Continuum: Un Marco Conceptual}
...
\begin{abstract}
Este trabajo introduce VEGA NBSMCI Continuum como un nuevo marco conceptual dentro del paradigma Resonance Data y QIRC.
\end{abstract}
