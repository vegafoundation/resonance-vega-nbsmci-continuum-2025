...
\title{VEGA NBSMCI Continuum: Концептуальная основа}
...
\begin{abstract}
Эта работа представляет VEGA NBSMCI Continuum как новую концептуальную основу в рамках парадигмы Resonance Data и QIRC.
\end{abstract}
