...
\title{VEGA NBSMCI Continuum: Kavramsal Bir Çerçeve}
...
\begin{abstract}
Bu çalışma, VEGA NBSMCI Continuum'i Resonance Data ve QIRC paradigması içinde yeni bir kavramsal çerçeve olarak tanıtmaktadır.
\end{abstract}
